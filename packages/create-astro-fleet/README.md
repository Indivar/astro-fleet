...
- `--template <source>` — giget source, default `github:indivar/astro-fleet#v2.4.0` (pinned to a specific fleet release tag; bumped inside the CLI when a new template ships)
